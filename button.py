...
option_button = pygame.image.load('image/option.png')
how_button = pygame.image.load('image/how.png')
how_to_play = pygame.image.load('image/how_to_play.png')
...
howButton = button(880,0,149,133) 
